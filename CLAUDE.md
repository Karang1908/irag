...
- Never hand-edit the generated CLAUDE.md or AGENTS.md in target
  projects — both are build artifacts of `irag export` (identical
  content, one per agent-file convention), regenerated on every update.
